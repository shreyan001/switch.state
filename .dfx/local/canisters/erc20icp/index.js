 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./erc20icp.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the erc20icp canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./erc20icp.did.js")._SERVICE>}
 */
export const erc20icp = createActor(canisterId);
